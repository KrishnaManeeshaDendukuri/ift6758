...
def roc_auc_plot(df_roc,df_auc, question_no = question_no, n_models = 5,list_labels = None):
    # list_labels =  ["1","2","3","4"]
    ...
    plt.yticks(size = 12)
    plt.xticks(size = 12)
    plt.savefig(f'../../ift6758-blog-template-main/figures/milestone2/Q{question_no}_combined_ROC_Curve.png',bbox_inches = 'tight')
    plt.show()
    
    return fig

def get_roc_auc_plot(df_prob,list_labels=None, question_no = question_no):
        """
        ...
        fig = roc_auc_plot(df_roc,df_auc, question_no = question_no, list_labels = list_labels)
        return fig
...
def goal_rate_plot(df_perc_prop,n_bins, question_no = question_no, list_labels = None, n_models = 5,):
    from matplotlib import pyplot as plt
    ...
    plt.savefig(f'../../ift6758-blog-template-main/figures/milestone2/Q{question_no}_combined_Goal_Rate.png',bbox_inches = 'tight')
    return fig

def get_goal_rate_plot(df_prob=None, n_bins = 20, quant = 5,list_labels = None, question_no = question_no):
        from matplotlib import pyplot as plt
        ...
        fig = goal_rate_plot(df_perc_prop = df_perc_prop,n_bins = n_bins, question_no = question_no, list_labels = list_labels, n_models = 5)    
        return fig
...
def cum_rate_plot(df_perc_prop_cum,n_bins, question_no = question_no, n_models= 5,list_labels = None):
    from matplotlib import pyplot as plt
    ...
    plt.xticks(size = 12)
    plt.legend(fontsize=12)
    fig.savefig(f'../../ift6758-blog-template-main/figures/milestone2/Q{question_no}_combined_Cum_Goal.png',bbox_inches = 'tight')
    
    return fig

def get_cum_rate_plot( df_prob=None, n_bins = 20, quant = 5,list_labels = None, question_no = question_no):
        from matplotlib import pyplot as plt
        ...
        fig = cum_rate_plot(df_perc_prop_cum, n_bins, question_no = question_no,n_models= 5,list_labels = list_labels)
        return fig

###############################################
#######           Calibration Curve     #######
###############################################
def calibration_plot(df_calib, n_bins, question_no = question_no, list_labels = None, n_models =5):
...
def get_calibration_plot(df_prob=None,n_bins = 20, question_no = question_no, list_labels = None):
        """
        df_prob: dataframe with model predictions
        ...
        fig = calibration_plot(df_calib,n_bins, question_no = question_no, list_labels = list_labels, n_models =5)
        return fig